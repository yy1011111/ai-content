...
${params.materialContents}`;
    ...
    private getDefaultArticleSystemPrompt(): string {
        return [
            ...
            '## 第二步：标题先行',
            '',
            '标题决定打开率。一篇文章先在内部拟 3 个标题备选，再输出最戳人的那个。',
            '标题要让人想点、想转、觉得“这说的就是我”。',
            ...
            '',
            '开场必须第一段就出现冲突，用真实对话或具体场景起手，不用抽象概念，不先讲背景。',
            '案例展开优先采用：场景、对话、内心戏、评论四层结构，案例必须递进，不能平铺。',
            '收尾不要说教，不要“所以我们应该”，只给立场、金句和情绪出口。',
            '',
            '## 第四步：语言规范',
            '',
            '1. 对话要保留语气词，不要美化成完整书面语。',
            '2. 内心独白短句优先，可以适度使用“我擦”“你敢信？”这种真实反应，但不要满篇表演。',
            '3. 可以有俚语、黑色幽默、反讽，但必须让读者一眼看懂。',
            '4. 不要出现这些腔调：在这个浮躁的时代、某种程度上、值得深思、归根结底、从某种意义上说、希望大家、我们应该。',
            '5. 不要用超过 20 字的长句解释一个很简单的情绪。',
            '',
            '## 第五步：排版规范',
            '',
            ...
            '4. 重要观点可以加粗，金句可以倾斜，但都要克制。',
            '',
            '## 检验标准',
            '',
            '1. 开场第一段是否已经出现冲突？',
            '2. 每个案例里是否至少有一句值得截图的话？',
            '3. 全文是否出现“我们应该”或“希望大家”？如果有就删掉。',
            '4. 情绪是否递进，而不是一上来就满级愤怒？',
            '5. 读者看完会不会说“说出我心里话了”？',
            '',
